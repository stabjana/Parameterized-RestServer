...
const StorageLayer = require('./storageLayer'); // we need a constructor because we need to pass


// we cant use the methods directly, we need to put this.#storage. in front of them
// changed prianry_key to this.PRIMARY_KEY
...
module.exports = class Datastorage {
    ...
    //getters
    get RESOURCE() {
        return this.#storage.RESOURCE; 'use strict';
    ...
    get PRIMARY_KEY() {
        return this.#storage.PRIMARY_KEY; // changed to capital letters + this.#storage.
    }
